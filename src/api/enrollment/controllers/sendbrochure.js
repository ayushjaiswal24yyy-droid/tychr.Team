...
module.exports = {
  async sendBrochureEmail(ctx) {
    ...
    if (!leadName || !email || !brochure) {
      return ctx.send({ error: "Missing required fields" }, 400);
    }
    const emailContent = `
      <h2>Thank You for Your Interest – Here's Your Brochure</h2>
      <p>Dear ${leadName},</p>
      <p>Thank you for reaching out to us regarding ${
        classname || "Student Plan"
      }. We appreciate your interest and are excited to share more information with you.</p>
      ...
      <p><a href="${
        brochure.url
      }" target="_blank">Click here to download your brochure</a></p>
